...
types of sensors certainly exists, and if legal claims are made courts will

likely consider the ethical standards that emerge in these next few years of
...
For journalists, the concept of \'ground-truthing\'—supplementing sensor
...
\chapter{The First Section: A Framework}


\section{The Landscape for Sensors and Journalism}
...
King Data and the Wide Angle for Journalism
...
homes and schools, more children learned programming skills. More systems and data about the world have been digitized. There are more stories
to be found in databases and more journalists working in the profession
...
newsworthy event.
Why Would Journalists Want to Sense?
...
Journalistic Sensing in This Report
...
Data Collection Beyond our Purview
...
for ushering polls into our work. However, the origin of polling data
...
\section{Sensors and Sensibilia: A Historical Survey}
By Charles Berret
...
Cairo, where the Nile splits into its vast delta, has traditionally been the

site where the river's annual flooding was measured by a variety of instruments
...
was organized by the Greek polymath Eratosthenes (276–195 B.C.E.), who

estimated the circumference of the Earth through a single well-timed measurement.
...
developing culture of the scientific laboratory. Among Leonardo da Vinci's
...
on the other hand, was the first to both create and play back brief

recordings from a wax cylinder. In both cases, the air pressure of the sound
...
were only able to make progress in their work once they could gather data

from a dispersed group of collaborators. Sensors enable us to investigate
...
\section{The Characteristics of Sensors}
...
Sensitivity to Target Phenomenon
...
\chapter{The Second Section: Case Studies}
...
research underpinning this report, we expected to have more examples of
...
\section{Houston Chronicle—In Harm's Way}
...
the Gulf Coast, community activist organizations had already developed
...
\section{Public Lab – Homebrew Sensing}
...
a small plastic version that clips on to the back of a smartphone and uses its
...
The Challenge for Citizen Science, and the Roadmap
...
\section{USA Today—Ghost Factories}
...
helped, along with some luck. In contrast with much modern infrastructure
...
one gate and the next. It took Kestin and Maines shoe leather, (or at least
...
circuit board with a printed circuit board (PCB) and swapping out the overpowered
...
\item The conditions were perfect for a price drop from \$200 to
about \$12.
